      ...
      <header className="pt-20 pb-12">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <div className="relative inline-block mb-8">
            <div className="w-48 h-48 mx-auto rounded-full overflow-hidden border-4 border-white shadow-2xl bg-slate-200">
              {/* Note que aqui usamos /new.jpg assumindo que a foto está na raiz da pasta public */}
              <img 
                src="/new.jpg" 
